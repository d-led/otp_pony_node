...
ifeq ($(config),debug)
  ...
  LIBS += -lei
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/local/Cellar/erlang/21.2.4/lib/erlang/lib/erl_interface-3.10.4/lib -m64 -dynamiclib -Wl,-install_name,@rpath/libotp_pony_node_c.so -std=c++11
